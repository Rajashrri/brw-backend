...
router.route("/getPageOptions2").get(Formmodulecontrollers.getPageOptions2);
router.route("/getTableData/:tableName").get(Formmodulecontrollers.getTableFieldData);
...
router.route("/gettemplateid/:id").get(Formmodulecontrollers.getTemplateId);
router.route("/deletetemp/:id").delete(Formmodulecontrollers.deletetemp);
