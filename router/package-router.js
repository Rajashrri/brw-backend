...
//category feature
router.route("/addcategory").post(Package.addcategory);
router.route("/getdatacategory").get(Package.getdatacategory);
router.route("/getcategoryByid/:id").get(Package.getcategoryByid);
router.route("/updateCategory/:id").patch(Package.updateCategory);

router.route("/deletecategory/:id").delete(Package.deletecategory);
router.route("/update-statuscategory").patch(Package.updateStatusCategory);
router.route("/categoryOptions").get(Package.categoryOptions);
router.route("/getCategoryOptionsTable").get(Package.getCategoryOptionsTable);
...
router.route("/frontlistpackage").get(Package.frontlistpackage);
router.route("/frontlistfeaturewithcat").get(Package.frontlistfeaturewithcat);
